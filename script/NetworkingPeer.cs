...
internal class NetworkingPeer : LoadbalancingPeer, IPhotonPeerListener
{
    ...
    internal protected string mCurrentLobbyName;

    internal protected LobbyType mCurrentLobbyType;
    ...
    public bool OpCreateGame(string gameID, bool isVisible, bool isOpen, byte maxPlayers, bool autoCleanUp, Hashtable customGameProperties, string[] propsListedInLobby)
    {
        ...
        // default lobbyname == null -> no lobby parameters are sent
        return base.OpCreateRoom(gameID, isVisible, isOpen, maxPlayers, autoCleanUp, customGameProperties, (onGameServer) ? this.GetLocalActorProperties() : null, propsListedInLobby, null, LobbyType.Default);
    }

    public bool OpCreateGame(string gameID, bool isVisible, bool isOpen, byte maxPlayers, bool autoCleanUp, Hashtable customGameProperties, string[] propsListedInLobby, string lobbyName, LobbyType lobbyType)
    {
        this.mRoomToGetInto = new Room(gameID, customGameProperties, isVisible, isOpen, maxPlayers, autoCleanUp, propsListedInLobby);
        bool onGameServer = this.State == global::PeerState.Joining;    // set before this method is called by OpResponse for Auth
        return base.OpCreateRoom(gameID, isVisible, isOpen, maxPlayers, autoCleanUp, customGameProperties, (onGameServer) ? this.GetLocalActorProperties() : null, propsListedInLobby, lobbyName, lobbyType);
    }
    ...
    public override bool OpJoinRandomRoom(Hashtable expectedCustomRoomProperties, byte expectedMaxPlayers, Hashtable playerProperties, MatchmakingMode matchingType, string lobbyName, LobbyType lobbyType, string sqlLobbyFilter)
    {
        this.mRoomToGetInto = new Room(null, null);
        return base.OpJoinRandomRoom(expectedCustomRoomProperties, expectedMaxPlayers, playerProperties, matchingType, lobbyName, lobbyType, sqlLobbyFilter);
    }
                        ...
                        else if (this.State == global::PeerState.ConnectedToGameserver)
                        {
                            ...
                            else if (this.mLastJoinType == JoinType.CreateGame)
                            {
                                ...
                                this.OpCreateGame(
                                    ...
                                    this.mCurrentLobbyName,
                                    this.mCurrentLobbyType);
                            }
