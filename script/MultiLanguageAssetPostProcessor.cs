...
public class MultiLanguageAssetPostProcessor : AssetPostprocessor 
{
	...
	public static readonly string MULTILANGUAGE_ASSETS_FOLDER = "Assets/Data/Localization";
	public static readonly string MULTILANGUAGE_COMMON_FOLDER = "Assets/Data/Localization/Common";
	public static readonly string MULTILANGUAGE_CONFIGFILE = "LocalizationFontConfig.asset";
	public static readonly string MULTILANGUAGE_LANGUAGESXML = "Languages.xml";
