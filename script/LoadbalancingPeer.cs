...
internal class LoadbalancingPeer : PhotonPeer
{
    ...
    /// </summary>
    public virtual bool OpCreateRoom(string roomName, bool isVisible, bool isOpen, byte maxPlayers, bool autoCleanUp, Hashtable customGameProperties, Hashtable customPlayerProperties, string[] customRoomPropertiesForLobby, string lobbyName, LobbyType lobbyType)
    {
        if (this.DebugOut >= DebugLevel.INFO)
        {
